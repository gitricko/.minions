...
```
terminal(command="bash skills/codespace-lavish/scripts/lavish_planning_gui.sh --fix", timeout=300)
```
...
bash skills/codespace-lavish/scripts/lavish_planning_gui.sh --fix

# Open a specific artifact:
bash skills/codespace-lavish/scripts/lavish_planning_gui.sh path/to/plan.html

# Generate from a prompt:
bash skills/codespace-lavish/scripts/lavish_planning_gui.sh --prompt "Plan the Q3 launch"

# Generate and monitor feedback live:
bash skills/codespace-lavish/scripts/lavish_planning_gui.sh --prompt "Plan the Q3 launch" --monitor

# Just check prerequisites (no launch):
bash skills/codespace-lavish/scripts/lavish_planning_prereqs.sh --fix
```
...
bash skills/codespace-lavish/scripts/lavish_planning_gui.sh --fix --prompt "Your planning prompt here"

# 3. Or with a specific artifact:
bash skills/codespace-lavish/scripts/lavish_planning_gui.sh --fix path/to/artifact.html

# 4. For live feedback monitoring:
bash skills/codespace-lavish/scripts/lavish_planning_gui.sh --fix --prompt "..." --monitor
