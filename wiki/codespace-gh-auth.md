...
- **Skill**: `../skills/codespace-gh-auth/` — Procedural how-to with git-push-with-token.md reference
- **Skill**: `../skills/github-codespace/` — Full Codespace workflow (auth, CI, PR)
